...
@_used
func rvnc_authentication_type_requires_username(_ authenticationType: RVNC_AUTHENTICATIONTYPE) -> Bool {
...
@_used
func rvnc_authentication_type_requires_password(_ authenticationType: RVNC_AUTHENTICATIONTYPE) -> Bool {
    let authenticationTypeSwift = authenticationType.swiftVNCAuthenticationType
