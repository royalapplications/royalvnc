...
@_used
func rvnc_connection_create(_ settings: rvnc_settings_t,
...
@_used
func rvnc_connection_destroy(_ connection: rvnc_connection_t) {
    VNCConnection.autoreleasePointer(connection)
}

@_cdecl("rvnc_connection_connect")
@_used
func rvnc_connection_connect(_ connection: rvnc_connection_t) {
...
@_used
func rvnc_connection_disconnect(_ connection: rvnc_connection_t) {
    VNCConnection.fromPointer(connection)
        .disconnect()
}
...
@_used
func rvnc_connection_update_color_depth(_ connection: rvnc_connection_t,
...
@_used
func rvnc_connection_delegate_set(_ connection: rvnc_connection_t,
...
@_used
func rvnc_connection_context_get(_ connection: rvnc_connection_t) -> rvnc_context_t? {
    let connectionSwift = VNCConnection.fromPointer(connection)
...
@_used
func rvnc_connection_state_get_copy(_ connection: rvnc_connection_t) -> rvnc_connection_state_t {
    let connectionSwift = VNCConnection.fromPointer(connection)
...
@_used
func rvnc_connection_settings_get_copy(_ connection: rvnc_connection_t) -> rvnc_settings_t {
    let connectionSwift = VNCConnection.fromPointer(connection)
...
@_used
func rvnc_connection_mouse_move(_ connection: rvnc_connection_t, _ x: UInt16, _ y: UInt16) {
    VNCConnection.fromPointer(connection)
        .mouseMove(x: x, y: y)
}
...
@_used
func rvnc_connection_mouse_down(_ connection: rvnc_connection_t, _ button: RVNC_MOUSEBUTTON, _ x: UInt16, _ y: UInt16) {
    VNCConnection.fromPointer(connection)
...
@_used
func rvnc_connection_mouse_up(_ connection: rvnc_connection_t, _ button: RVNC_MOUSEBUTTON, _ x: UInt16, _ y: UInt16) {
    VNCConnection.fromPointer(connection)
...
@_used
func rvnc_connection_mouse_wheel(_ connection: rvnc_connection_t, _ wheel: RVNC_MOUSEWHEEL, _ x: UInt16, _ y: UInt16, _ steps: UInt32) {
    VNCConnection.fromPointer(connection)
...
@_used
func rvnc_connection_key_down(_ connection: rvnc_connection_t, _ key: UInt32) {
    VNCConnection.fromPointer(connection)
        .keyDown(.init(key))
}
...
@_used
func rvnc_connection_key_up(_ connection: rvnc_connection_t, _ key: UInt32) {
    VNCConnection.fromPointer(connection)
        .keyUp(.init(key))
}
